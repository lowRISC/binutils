...
const char riscv_wdr_names_numeric[NWDR][NRC] =
{
...
/* OTBN flag groups. */
const char * const riscv_otbn_fg[2] = {
  "FG0", "FG1"
};

/* OTBN WSRs */
const char * const riscv_otbn_wsr[8] = {
  "MOD", "RND", "URND", "ACC",
  "KEY_S0_L", "KEY_S0_H", "KEY_S1_L", "KEY_S1_H",
};

const char * const riscv_otbn_sel_fg[12] = {
  "C", "M", "L", "Z",
  "FG1.C", "FG1.M", "FG1.L", "FG1.Z",
  "FG0.C", "FG0.M", "FG0.L", "FG0.Z"
};
...
{"bn.add",          0, INSN_CLASS_OTBN, "+a,+b,+s,+F",    MATCH_BN_ADD, MASK_BN_ADD, match_opcode, 0 },
{"bn.addc",         0, INSN_CLASS_OTBN, "+a,+b,+s,+F",    MATCH_BN_ADDC, MASK_BN_ADDC, match_opcode, 0 },
{"bn.addi",         0, INSN_CLASS_OTBN, "+a,+b,+I,+F",    MATCH_BN_ADDI, MASK_BN_ADDI, match_opcode, 0 },
{"bn.addm",         0, INSN_CLASS_OTBN, "+a,+b,+c",       MATCH_BN_ADDM, MASK_BN_ADDM, match_opcode, 0 },
{"bn.mulqacc",      0, INSN_CLASS_OTBN, "+e,+f,+>",       MATCH_BN_MULQACC, MASK_BN_MULQACC, match_opcode, 0 },
{"bn.mulqacc.z",    0, INSN_CLASS_OTBN, "+e,+f,+>",       MATCH_BN_MULQACC_Z, MASK_BN_MULQACC_Z, match_opcode, 0 },
{"bn.mulqacc.wo",   0, INSN_CLASS_OTBN, "+a,+e,+f,+>,+F", MATCH_BN_MULQACC_WO, MASK_BN_MULQACC_WO, match_opcode, 0 },
{"bn.mulqacc.wo.z", 0, INSN_CLASS_OTBN, "+a,+e,+f,+>,+F", MATCH_BN_MULQACC_WO_Z, MASK_BN_MULQACC_WO_Z, match_opcode, 0 },
{"bn.mulqacc.so",   0, INSN_CLASS_OTBN, "+h,+e,+f,+>,+F", MATCH_BN_MULQACC_SO, MASK_BN_MULQACC_SO, match_opcode, 0 },
{"bn.mulqacc.so.z", 0, INSN_CLASS_OTBN, "+h,+e,+f,+>,+F", MATCH_BN_MULQACC_SO_Z, MASK_BN_MULQACC_SO_Z, match_opcode, 0 },
{"bn.sub",          0, INSN_CLASS_OTBN, "+a,+b,+s,+F",    MATCH_BN_SUB, MASK_BN_SUB, match_opcode, 0 },
{"bn.subb",         0, INSN_CLASS_OTBN, "+a,+b,+s,+F",    MATCH_BN_SUBB, MASK_BN_SUBB, match_opcode, 0 },
{"bn.subi",         0, INSN_CLASS_OTBN, "+a,+b,+I,+F",    MATCH_BN_SUBI, MASK_BN_SUBI, match_opcode, 0 },
{"bn.subm",         0, INSN_CLASS_OTBN, "+a,+b,+c",       MATCH_BN_SUBM, MASK_BN_SUBM, match_opcode, 0 },
{"bn.and",          0, INSN_CLASS_OTBN, "+a,+b,+s,+F",    MATCH_BN_AND, MASK_BN_AND, match_opcode, 0 },
{"bn.or" ,          0, INSN_CLASS_OTBN, "+a,+b,+s,+F",    MATCH_BN_OR, MASK_BN_OR, match_opcode, 0 },
{"bn.not" ,         0, INSN_CLASS_OTBN, "+a,+s,+F",       MATCH_BN_NOT, MASK_BN_NOT, match_opcode, 0 },
{"bn.xor",          0, INSN_CLASS_OTBN, "+a,+b,+s,+F",    MATCH_BN_XOR, MASK_BN_XOR, match_opcode, 0 },
{"bn.rshi",         0, INSN_CLASS_OTBN, "+a,+b,+t",       MATCH_BN_RSHI, MASK_BN_RSHI, match_opcode, 0 },
{"bn.sel",          0, INSN_CLASS_OTBN, "+a,+b,+c,+Z",    MATCH_BN_SEL, MASK_BN_SEL, match_opcode, 0 },
{"bn.cmp" ,         0, INSN_CLASS_OTBN, "+b,+s,+F",       MATCH_BN_CMP, MASK_BN_CMP, match_opcode, 0 },
{"bn.cmpb" ,        0, INSN_CLASS_OTBN, "+b,+s,+F",       MATCH_BN_CMPB, MASK_BN_CMPB, match_opcode, 0 },
{"bn.lid",          0, INSN_CLASS_OTBN, "+i,+o(+k)",      MATCH_BN_LID, MASK_BN_LID, match_opcode, 0 },
{"bn.sid",          0, INSN_CLASS_OTBN, "+i,+o(+k)",      MATCH_BN_SID, MASK_BN_SID, match_opcode, 0 },
{"bn.mov",          0, INSN_CLASS_OTBN, "+a,+b",          MATCH_BN_MOV, MASK_BN_MOV, match_opcode, 0 },
{"bn.movr",         0, INSN_CLASS_OTBN, "+i,+j",          MATCH_BN_MOVR, MASK_BN_MOVR, match_opcode, 0 },
...
{"loopi",       0, INSN_CLASS_OTBN, "+J,+B",       MATCH_LOOPI, MASK_LOOPI, match_opcode, 0 },
...
{"unimp",       0, INSN_CLASS_OTBN, "",       MATCH_CSRRW|(CSR_CYCLE << OP_SH_CSR), 0xffffffffU,  match_opcode, 0 }, /* csrw cycle, x0  */
...
{"ret",         0, INSN_CLASS_OTBN, "",       MATCH_JALR|(X_RA << OP_SH_RS1), MASK_JALR|MASK_RD|MASK_RS1|MASK_IMM, match_opcode, INSN_ALIAS|INSN_BRANCH },
...
{"jalr",        0, INSN_CLASS_OTBN, "d,s,j",  MATCH_JALR, MASK_JALR, match_opcode, INSN_JSR },
...
{"jal",         0, INSN_CLASS_OTBN, "d,a",    MATCH_JAL, MASK_JAL, match_opcode, INSN_JSR },
...
{"nop",         0, INSN_CLASS_OTBN, "",       MATCH_ADDI, MASK_ADDI|MASK_RD|MASK_RS1|MASK_IMM, match_opcode, INSN_ALIAS },
...
{"lui",         0, INSN_CLASS_OTBN, "d,u",    MATCH_LUI, MASK_LUI, match_opcode, 0 },
...
{"li",          0, INSN_CLASS_OTBN, "d,I",    0, (int) M_LI,  NULL, INSN_MACRO },
...
{"andi",        0, INSN_CLASS_OTBN, "d,s,j",  MATCH_ANDI, MASK_ANDI, match_opcode, 0 },
...
{"and",         0, INSN_CLASS_OTBN, "d,s,j",  MATCH_ANDI, MASK_ANDI, match_opcode, INSN_ALIAS },
...
{"beq",         0, INSN_CLASS_OTBN, "s,t,p",  MATCH_BEQ, MASK_BEQ, match_opcode, INSN_CONDBRANCH },
...
{"bne",         0, INSN_CLASS_OTBN, "s,t,p",  MATCH_BNE, MASK_BNE, match_opcode, INSN_CONDBRANCH },
...
{"addi",        0, INSN_CLASS_OTBN, "d,s,j",  MATCH_ADDI, MASK_ADDI, match_opcode, 0 },
...
{"add",         0, INSN_CLASS_OTBN, "d,s,t",  MATCH_ADD, MASK_ADD, match_opcode, 0 },
{"la",          0, INSN_CLASS_I, "d,B",       0, (int) M_LA, match_rd_nonzero, INSN_MACRO },
{"la",          0, INSN_CLASS_OTBN, "d,B",    0, (int) M_LA, match_rd_nonzero, INSN_MACRO },
...
{"slli",        0, INSN_CLASS_OTBN, "d,s,>",  MATCH_SLLI, MASK_SLLI, match_opcode, 0 },
...
{"srli",        0, INSN_CLASS_OTBN, "d,s,>",  MATCH_SRLI, MASK_SRLI, match_opcode, 0 },
...
{"srai",        0, INSN_CLASS_OTBN, "d,s,>",  MATCH_SRAI, MASK_SRAI, match_opcode, 0 },
...
{"sub",         0, INSN_CLASS_OTBN, "d,s,t",  MATCH_SUB, MASK_SUB, match_opcode, 0 },
...
{"lw",          0, INSN_CLASS_OTBN, "d,o(s)", MATCH_LW, MASK_LW, match_opcode, INSN_DREF|INSN_4_BYTE },
...
{"ori",         0, INSN_CLASS_OTBN, "d,s,j",  MATCH_ORI, MASK_ORI, match_opcode, 0 },
...
{"or",          0, INSN_CLASS_OTBN, "d,s,t",  MATCH_OR, MASK_OR, match_opcode, 0 },
...
{"ecall",       0, INSN_CLASS_OTBN, "",       MATCH_SCALL, MASK_SCALL, match_opcode, 0 },
{"scall",       0, INSN_CLASS_I, "",          MATCH_SCALL, MASK_SCALL, match_opcode, 0 },
{"xori",        0, INSN_CLASS_I, "d,s,j",     MATCH_XORI, MASK_XORI, match_opcode, 0 },
{"xori",        0, INSN_CLASS_OTBN, "d,s,j",  MATCH_XORI, MASK_XORI, match_opcode, 0 },
...
{"xor",         0, INSN_CLASS_OTBN, "d,s,t",  MATCH_XOR, MASK_XOR, match_opcode, 0 },
...
{"pack",       0, INSN_CLASS_ZBP_OR_ZBE_OR_ZBF_OR_ZBKB,  "d,s,t",    MATCH_PACK, MASK_PACK, match_opcode, 0 },
{"packh",      0, INSN_CLASS_ZBP_OR_ZBE_OR_ZBF_OR_ZBKB,  "d,s,t",    MATCH_PACKH, MASK_PACKH, match_opcode, 0 },
{"packw",     64, INSN_CLASS_ZBP_OR_ZBE_OR_ZBF_OR_ZBKB,  "d,s,t",    MATCH_PACKW, MASK_PACKW, match_opcode, 0 },
{"andn",       0, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,t", MATCH_ANDN, MASK_ANDN, match_opcode, 0 },
{"orn",        0, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,t", MATCH_ORN, MASK_ORN, match_opcode, 0 },
{"xnor",       0, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,t", MATCH_XNOR, MASK_XNOR, match_opcode, 0 },
{"rol",        0, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,t", MATCH_ROL, MASK_ROL, match_opcode, 0 },
{"rori",       0, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,>", MATCH_RORI, MASK_RORI, match_opcode, 0 },
{"ror",        0, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,t", MATCH_ROR, MASK_ROR, match_opcode, 0 },
{"ror",        0, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,>", MATCH_RORI, MASK_RORI, match_opcode, INSN_ALIAS },
...
{"rolw",      64, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,t", MATCH_ROLW, MASK_ROLW, match_opcode, 0 },
{"roriw",     64, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,<", MATCH_RORIW, MASK_RORIW, match_opcode, 0 },
{"rorw",      64, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,t", MATCH_RORW, MASK_RORW, match_opcode, 0 },
{"rorw",      64, INSN_CLASS_ZBB_OR_ZBP_OR_ZBKB,  "d,s,<", MATCH_RORIW, MASK_RORIW, match_opcode, INSN_ALIAS },
...
{"csrrw",      0, INSN_CLASS_OTBN,  "d,+C,s",MATCH_CSRRW, MASK_CSRRW, match_opcode, 0 },
...
{"csrrs",      0, INSN_CLASS_OTBN,  "d,+C,s", MATCH_CSRRS, MASK_CSRRS, match_opcode, 0 },
...
{"sloi",          0, INSN_CLASS_ZBP, "d,s,>", MATCH_SLOI, MASK_SLOI, match_opcode, 0},
{"slo",           0, INSN_CLASS_ZBP, "d,s,t", MATCH_SLO, MASK_SLO, match_opcode, 0},
{"slo" ,          0, INSN_CLASS_ZBP, "d,s,>", MATCH_SLOI, MASK_SLOI, match_opcode, INSN_ALIAS},
{"sloiw",        64, INSN_CLASS_ZBP, "d,s,<", MATCH_SLOIW, MASK_SLOIW, match_opcode, 0},
{"slow",         64, INSN_CLASS_ZBP, "d,s,t", MATCH_SLOW, MASK_SLOW, match_opcode, 0},
{"slow",         64, INSN_CLASS_ZBP, "d,s,<", MATCH_SLOIW, MASK_SLOIW, match_opcode, INSN_ALIAS},
{"sroi",          0, INSN_CLASS_ZBP, "d,s,>", MATCH_SROI, MASK_SROI, match_opcode, 0},
{"sro",           0, INSN_CLASS_ZBP, "d,s,t", MATCH_SRO, MASK_SRO, match_opcode, 0},
{"sro" ,          0, INSN_CLASS_ZBP, "d,s,>", MATCH_SROI, MASK_SROI, match_opcode, INSN_ALIAS},
{"sroiw",        64, INSN_CLASS_ZBP, "d,s,<", MATCH_SROIW, MASK_SROIW, match_opcode, 0},
{"srow",         64, INSN_CLASS_ZBP, "d,s,t", MATCH_SROW, MASK_SROW, match_opcode, 0},
{"srow",         64, INSN_CLASS_ZBP, "d,s,<", MATCH_SROIW, MASK_SROIW, match_opcode, INSN_ALIAS},
...
{"shfli",         0, INSN_CLASS_ZBP, "d,s,_", MATCH_SHFLI, MASK_SHFLI, match_opcode, 0},
{"shfl",          0, INSN_CLASS_ZBP, "d,s,t", MATCH_SHFL, MASK_SHFL, match_opcode, 0},
{"shfl",          0, INSN_CLASS_ZBP, "d,s,_", MATCH_SHFLI, MASK_SHFLI, match_opcode, INSN_ALIAS},
{"shflw",        64, INSN_CLASS_ZBP, "d,s,t", MATCH_SHFLW, MASK_SHFLW, match_opcode, 0},
{"unshfli",       0, INSN_CLASS_ZBP, "d,s,_", MATCH_UNSHFLI, MASK_UNSHFLI, match_opcode, 0},
{"unshfl",        0, INSN_CLASS_ZBP, "d,s,t", MATCH_UNSHFL, MASK_UNSHFL, match_opcode, 0},
{"unshfl",        0, INSN_CLASS_ZBP, "d,s,_", MATCH_UNSHFLI, MASK_UNSHFLI, match_opcode, INSN_ALIAS},
